...
1. Замените в файлах папки все вхождения "mynamespace*myapp" на ваше "lim_market" (имя компании*проект). Это заменит все view.tree файлы
2. Замените в файлах папки все вхождения "mynamespace/myapp" на ваше "lim/market" (имя компании/проект). Это заменит все deploy.yaml файлы
