...
;
	($.$mynamespace_myapp_logo_demo) = class $mynamespace_myapp_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$mynamespace_myapp_logo_demo.prototype), "Logo"));
...
;
	($.$mynamespace_myapp_button_demo) = class $mynamespace_myapp_button_demo extends ($.$mol_example_small) {
		Login(){
	...
	($mol_mem(($.$mynamespace_myapp_button_demo.prototype), "Login"));
	($mol_mem(($.$mynamespace_myapp_button_demo.prototype), "Logout"));
...
;
	($.$mynamespace_myapp_docs) = class $mynamespace_myapp_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
